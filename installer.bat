...
.\windbg -QY -g -G -y "%~dp0\lib\masm\;%~dp0\lib\;c:\windows\system32\;SRV*C:\symbols*http://msdl.microsoft.com/download/symbols" -WF "%~dp0\lib\masm\wkp.wew" -srcpath "%~dp0\lib\masm\" %1.exe
